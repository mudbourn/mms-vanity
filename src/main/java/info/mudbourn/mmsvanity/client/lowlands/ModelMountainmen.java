...
/**
 * Mountainmen — {@code lowlands_clothing:mountainmen__clothes}.
 *
 * <p>Geometry transcribed from the source mod's {@code Modelmountainmenclothes}. The six root
 ...
 */
public final class ModelMountainmen extends LowlandsArmorModel {

    public ModelMountainmen(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        Head.addOrReplaceChild(
           "Head_r1",
           CubeListBuilder.create().texOffs(0, 27).addBox(-4.0F, -2.0F, -4.0F, 9.0F, 4.0F, 9.0F, new CubeDeformation(0.8F)),
